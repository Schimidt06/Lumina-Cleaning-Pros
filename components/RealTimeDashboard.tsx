...
export const RealTimeDashboard: React.FC<RealTimeDashboardProps> = ({ lang, darkMode }) => {
  ...
  return (
    <div className={`p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-[2.5rem] md:rounded-[3rem] border transition-all ${darkMode ? 'bg-slate-900 border-white/5 shadow-2xl' : 'bg-white border-slate-100 shadow-xl'}`}>
